...
<b>
Hello {} there! 👋 \nThis bot 🤖 is solely dedicated to cloud computing. Just send me any link you'd like, such as YouTube 📺, Facebook 📘, or even a direct download link ⬇️. Then, the bot will download and store the file right in your Telegram. 🌐
</b>
"""
...
🌀 ᴄʜᴀɴɴᴇʟ : <a href="https://t.me/PandaWep">PandaWep</a>

🌺 PandaWep : <a href="https://PandaWep">PandaWep</a>

📑 ʟᴀɴɢᴜᴀɢᴇ : <a href="https://www.python.org/">ᴘʏᴛʜᴏɴ 3.10.5</a>

🇵🇲 ғʀᴀᴍᴇᴡᴏʀᴋ : <a href="https://docs.pyrogram.org/">ᴘʏʀᴏɢʀᴀᴍ 2.0.30</a>

👲 ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href="https://t.me/PandaWep">PandaWep</a></b>
...
"""
    ...
    TECH_VJ_START_BUTTONS = InlineKeyboardMarkup(
        [[
            InlineKeyboardButton('💝 sᴜʙsᴄʀɪʙᴇ ᴍʏ ʏᴏᴜᴛᴜʙᴇ ᴄʜᴀɴɴᴇʟ', url='https://youtube.com/@PandaWep')
        ], [
            ...
            InlineKeyboardButton('🇮🇳 ғᴏʟʟᴏᴡ ᴍᴇ ᴏɴ ɪɴsᴛᴀɢʀᴀᴍ 💖', url='https://instagram.com/PandaWep1')
        ]]
    )
    ...
    TECH_VJ_UPLOAD_START = "<b>📤 ᴜᴘʟᴏᴀᴅɪɴɢ...\n\n</b>"
    ...
    TECH_VJ_SAVED_CUSTOM_THUMB_NAIL = ""
